...
internals.getParamsData = function (param, name) {
    ...
    var data = {
        ...
        meta: param.meta,
        unit: param.unit,
        default: param.flags && param.flags.default,
        allowUnknown: param.flags && 'allowUnknown' in param.flags && param.flags.allowUnknown.toString(),
        ...
        encoding: param.flags && param.flags.encoding,
    ...
    } else if (['array', 'binary', 'date', 'object'].indexOf(data.type) !== -1) {
